	...
	def post(self, *args, **kwargs):
		...
		if app_settings.LOGIN_ON_EMAIL_CONFIRMATION:
			...
			if resp:
				...
				perfil = Perfil()
				perfil.usuario = user
				perfil.mi_email = user.email
				perfil.creado_por = user
				perfil.modificado_por = user
				perfil.save()
				
				config_perfil = Config_perfil()
				config_perfil.usuario = user
				config_perfil.creado_por = user
				config_perfil.modificado_por = user
				config_perfil.save()
